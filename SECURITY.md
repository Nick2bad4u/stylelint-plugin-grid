...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/stylelint-plugin-grid/security/advisories/new>
...
- Keep `stylelint-plugin-grid`, Stylelint, and dependencies updated.
